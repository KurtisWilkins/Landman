...
function renderWidget(route = "/acquisitions/dl_42/proforma") {
...
describe("FeedbackWidget", () => {
  ...
  it("submits a bug with silently-captured context and uses no browser storage", async () => {
    ...
    expect(body.context.page_route).toBe("/acquisitions/dl_42/proforma");
    expect(body.context.acquisition_id).toBe("dl_42");
